...
beautiful.init(awful.util.get_themes_dir() .. "nemo/theme.lua")
...
tags = {
    layout = { awful.layout.suit.floating, awful.layout.suit.tile, awful.layout.suit.tile, awful.layout.suit.tile, awful.layout.suit.floating, awful.layout.suit.floating }
}
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Internet", "Docs", "Media", "あ", "い", "う" }, s, tags.layout)
